...
let daysMonthsArray = Array(arrayLiteral: "31", "28", "31", "30", "31", "30", "31", "31", "30", "31", "30", "31")

for counter in 0..<daysMonthsArray.count {
    print(daysMonthsArray[counter])
}
// Количество днев в каждом месяце без имён

for day in 0..<12 {
    print(daysMonthsArray[day])
}

// Массив с именами месяцев (месяц + кол-во дней)

let days = daysMonthsArray
let months = ["январь", "февраль", "март", "арель", "май", "июнь", "июль", "август", "сентябрь", "октябрь", "ноябрь", "декабрь"]
...
var boy = ["Anton", "Petr", "Alex", "Jan", "Oleg", "Max", "Vlad", "Danil", "Egor", "Karl", "Mark", "Roma"]

boy.append("Kira")
boy.insert("Olga", at: 13)
boy.append("Anna")
boy.insert("Alya", at: 15)
boy.append("Nona")
boy.insert("Vika", at: 17)
boy.append("Katya")
...
boy.removeSubrange(0...6)
boy.removeSubrange(10...11)
...
var gradesDescription = [(1, "отвратительно"), (2, "ужасно"), (3, "очень плохо"), (4, "плохо"), (5, "неплохо"), (6, "нормально"), (7, "хорошо"), (8, "очень хорошо"), (9, "отлично"), (10, "превосходно")]
    ...
    for index in 0..<boy.count {
        print("\(boy[index]) — \(gradesDescription[index].0) баллов. \(gradesDescription[index].1)")
    }
